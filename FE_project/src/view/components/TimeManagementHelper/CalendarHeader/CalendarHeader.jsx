...
const CalendarHeader = ({
  ...
  const CalendarPopup = () => {
    ...
    return (
      <div className="calendar-popup">
        {/* כותרת החודש ושנה בתוך הלוח שנה */}
  ...
  return (
    <div className="calendar-header-container">
      {/* Left side (Date selector by view type) */}
      ...
      <div className="filters-container">
        ...
        <div className="event-filter">
          <button
            ...
            className={`event-filter-button ${eventType === "הכל" ? 'active' : ''}`}
          >
            הכל
          </button>
          ...
          <button
            ...
            className={`event-filter-button ${eventType === "לימודים" ? 'active' : ''}`}
          >
          ...
          <button
            ...
            className={`event-filter-button ${eventType === "אישי" ? 'active' : ''}`}
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
