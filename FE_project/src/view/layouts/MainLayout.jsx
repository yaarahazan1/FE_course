...
const MainLayout = () => {
  ...
  const hideHeaderPaths = ['/', '/Home', '/Login', '/Signup', '/Dashboard', '/HelpSettings', '/Support', '/AdminManagement', '/ForgotPassword'];
        ...
        <footer className="footer">
          <div className="footer-container">
            <div className="footer-links">
              ...
              <Link to="/Support" className="footer-link">תמיכה ושירות</Link>
              <span className="footer-separator">|</span>
